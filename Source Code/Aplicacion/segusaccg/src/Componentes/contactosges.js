...
class contactosges extends Component {
    ...
    submitEliminar = e => {
        ...
        axios.delete(`http://localhost:4000/api/contactos/${this.state.id}`)
            .then(response => {
                console.log(response);
                axios.get('http://localhost:4000/api/contactos')
                    .then(response => {
    ...
    submitBusqueda() {
        window.location.assign('http://localhost:3000/busquedacontactos');
    }
    ...
    render() {
        ...
        return (
            ...
            <div className="cont">
                ...
                <input name="buttonr" type="button" id="botonbs" onClick={this.submitBusqueda} value="Busqueda"/>
