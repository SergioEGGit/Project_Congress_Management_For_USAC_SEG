...
class productos extends Component {
    ...
    render() {
        const {usuarios, codigo, nombre, descripcion, cantidad, encargado, ubicacion, estado , tipo} = this.state;
        ...
        return (
            ...
            <div className="cont">
                ...
                <label id="ples9887" name="labelp">Tipo:</label>
                <input name="buttoni" type="button" id="pbc89" onClick={this.submitHandler} value="Crear"/>
                <input name="buttonr" type="button" id="pbg89" onClick={this.gestionar} value="Gestionar"/>
